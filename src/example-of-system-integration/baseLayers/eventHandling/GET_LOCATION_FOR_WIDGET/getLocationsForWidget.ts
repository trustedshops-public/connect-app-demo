...
export function getLocationsForWidget() {
  const getWidgetLocationFromApi = api.getWidgetLocation()
  BaseLayerLogger('Demo: GET_LOCATION_FOR_WIDGET. Answer:', getWidgetLocationFromApi)

  dispatchAction({
    action: EVENTS.SET_LOCATION_FOR_WIDGET,
    payload: getWidgetLocationFromApi,
  })
}
